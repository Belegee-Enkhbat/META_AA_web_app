  ...
  return (
    <div className="simple-recommendation bg-white border rounded-lg p-4 my-2">
      ...
      <div className="flex gap-2">
        {!expanded && <button className="expand-details-btn" onClick={onExpand}>詳細を表示 ▼</button>}
        {expanded && <button className="collapse-details-btn" onClick={onCollapse}>詳細を非表示 ▲</button>}
